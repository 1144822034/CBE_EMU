...
WASM_VERSION := $(WASM_BUILD_DIR)/cbe-version.json
...
wasm: wasm-assets $(WASM_BUILD_DIR)/cbe-emu.js $(WASM_VERSION)
...
$(WASM_VERSION): $(WASM_BUILD_DIR)/cbe-emu.js scripts/write-wasm-version.ps1
	powershell -NoProfile -ExecutionPolicy Bypass -File scripts/write-wasm-version.ps1
