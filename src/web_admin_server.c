                                           ...
                                           const char *query)
{
    ...
    vm_mock_admin_text_appendf(
        &page,
        "</div><div class=\"group\"><h2>任务目标</h2><p class=\"hint\">默认无目标。新增后可配置收集物品或击败怪物；击败怪物可额外限定 SCE 场景。当前客户端协议最多支持 2 个目标。</p><div class=\"task-target-list\" id=\"task-requirement-list\">");
