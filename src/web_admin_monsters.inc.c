                                               ...
                                               const char *query)
{
    ...
    vm_mock_admin_text_appendf(
        ...
        "<div class=\"grid\"><aside class=\"card catalog\" data-monster-batch-manager><input class=\"search\" id=\"monster-search\" placeholder=\"按 ID、名称或场景筛选\"><strong>怪物目录（%u）</strong><div class=\"monster-batch-tools\"><button class=\"secondary\" type=\"button\" data-monster-batch-select-visible>全选当前筛选</button><button class=\"secondary\" type=\"button\" data-monster-batch-clear>清除选择</button><form method=\"post\" action=\"/action\" data-monster-action data-confirm-message=\"将按各自当前等级与类型重置所选怪物的 HP、MP、攻击、防御、经验和铜钱；物品掉落不变。是否继续？\"><input type=\"hidden\" name=\"action\" value=\"reset-monster-combat-stats-bulk\"><input type=\"hidden\" name=\"monster_id\" value=\"%u\"><input type=\"hidden\" name=\"monster_ids\" value=\"\" data-monster-batch-ids><button class=\"danger\" type=\"submit\" data-monster-batch-reset disabled>批量重置属性与奖励（0）</button></form></div><div class=\"list\" id=\"monster-list\" data-admin-list>",
    ...
    vm_mock_admin_text_appendf(
        &page,
        "<form class=\"actions\" method=\"post\" action=\"/action\" data-monster-action data-confirm-message=\"按当前等级和怪物类型重新计算 HP、MP、攻击、防御、经验和铜钱；物品掉落与其他配置保持不变。是否继续？\"><input type=\"hidden\" name=\"action\" value=\"reset-monster-combat-stats\"><input type=\"hidden\" name=\"monster_id\" value=\"%u\"><button class=\"secondary\" type=\"submit\">重置属性与结算奖励</button></form>",
        edit->enemyId);
    if (edit->overridden)
    {
        vm_mock_admin_text_appendf(
