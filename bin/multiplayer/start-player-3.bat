...
rem Player-3's currently deployed little monkey uses the user-configured ID 1000.
rem Override this before launch only when testing a different deployed monster ID.
if "%CBE_TRACE_SCE_NODE_ACTOR_ID%"=="" set "CBE_TRACE_SCE_NODE_ACTOR_ID=1000"
if "%CBE_TRACE_SCENE_BATTLE_CONTROL_STATE%"=="" set "CBE_TRACE_SCENE_BATTLE_CONTROL_STATE=1"
if "%CBE_TRACE_SCENE_ASSET_LIFECYCLE%"=="" set "CBE_TRACE_SCENE_ASSET_LIFECYCLE=1"
